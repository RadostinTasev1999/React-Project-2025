...
export default function usePersistedState(stateKey, inititalState) {
    ...
    const [state,setState] = useState(() => {
        ...
        const persistedData = JSON.stringify(data) // convert to JSON string
        '{}'
       
        localStorage.setItem(stateKey, persistedData) // save to local storage under stateKey
        '{}'
        ...
        */
        setState(data) // update state property
