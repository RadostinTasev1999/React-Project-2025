...
// ! React Hook for generating unique IDs that can be passed to accessibility attributes.
    ...
    const products = [
      ...
      { name: 'Teams panels',imageUrl: 'https://blog.webex.com/wp-content/uploads/2024/11/room-nva-teams-version-two.jpg'},
      { name: 'Speakerphones',imageUrl: 'https://www.yealink.com/website-service/attachment/product/image/20220422/202204220610548508415beae41a4a6717cfaa6a892e4.png'},
      { name: 'Desk phones', imageUrl:'https://www.yealink.com/website-service/attachment/product/image/20220414/20220414124315871e109ac5f4f8c81b196bbcf67380f.png' },
      { name: 'Teams Rooms',imageUrl: 'https://p1-ofp.static.pub/medias/bWFzdGVyfHJvb3R8MjQ1MDE4fGltYWdlL3BuZ3xoODgvaGEzLzExMDQxMzA4ODY4NjM4LnBuZ3w4YjYxNjAwYzY4ZjdlNzEwOWM3OGNhMDFiMTc2MDgwYmNmNDk3ODAzNTVjN2QwZTlkNDAwNjRjOTkxZjczYTVk/lenovo-device-thinksmart-hub-for-teams-subseries-hero.png' },
    ]
